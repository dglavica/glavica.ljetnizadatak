...
import controller.ObradaBenzinskaCrpka;
 ...
 * @author Avalg
 */
public class FormaBenzinskaCrpka extends javax.swing.JFrame {

    private ObradaBenzinskaCrpka obrada;
    ...
    public FormaBenzinskaCrpka() {
        initComponents();
        obrada = new ObradaBenzinskaCrpka();
        benzinskacrpka = new BenzinskaCrpka();
    ...
    private void btnDodajActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDodajActionPerformed
        benzinskacrpka.setNaziv(txtNaziv.getText());
        benzinskacrpka.setAdresa(txtAdresa.getText());
        benzinskacrpka.setOib(txtOib.getText());
        benzinskacrpka.setEmail(txtEmail.getText());
        obrada.kreirajBenzinskaCrpka(benzinskacrpka);
        ucitaj();
    ...
    private void btnPromijeniActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPromijeniActionPerformed
        benzinskacrpka.setSifra(lstBenzinskeCrpke.getSelectedValue().getSifra());
        benzinskacrpka.setNaziv(txtNaziv.getText());
        benzinskacrpka.setAdresa(txtAdresa.getText());
        benzinskacrpka.setOib(txtOib.getText());
        benzinskacrpka.setEmail(txtEmail.getText());
        obrada.promjeniBenzinskaCrpka(benzinskacrpka);
        ucitaj();
    ...
    private void btnObrisiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnObrisiActionPerformed
        benzinskacrpka.setSifra(lstBenzinskeCrpke.getSelectedValue().getSifra());
        obrada.obrisiBenzinskaCrpka(benzinskacrpka);
        ucitaj();
    ...
    private void ucitaj() {
        DefaultListModel<BenzinskaCrpka> b = new DefaultListModel<BenzinskaCrpka>();
        lstBenzinskeCrpke.setModel(b);
        for (BenzinskaCrpka bc : obrada.getBenzinskeCrpke()) {
            b.addElement(bc);
